# -*- coding: utf-8 -*-
"""
Created on Fri Apr  7 09:13:15 2023
...
### Strategy 2: 100% electrification
...
df_hybrid['Energy']=energyConsumption_e(df_hybrid)
...
df_final.to_csv(r'../../results/simulated-fuel-rates-100-beb.csv')


### Strategy 3: 100%hybrid
# Compute energy consumption for "Conventional", "hybrid" and "electric" buses
df_conventional['Energy']=energyConsumption_d(df_conventional, hybrid=True)
...
df_final.to_csv(r'../../results/simulated-fuel-rates-100-heb.csv')