...
#M_cap = [92, 92, 108, 152, 168, 208, 292, 408, 572, 800, 1120, 1568, 2336] # Sensitivity analysis of +300% variation of charging capacity
...
range_BEB= 23-10 # Sensitivity analysis of -50% variation of BEB range
#range_BEB= 44-10 # Sensitivity analysis of -20% variation of BEB range
#range_BEB= 66-10 # Sensitivity analysis of +20% variation of BEB range
#range_BEB= 110-10 # Sensitivity analysis of +100% variation of BEB range
...
#df.to_csv(r'../../results/midcap-BM-optimized-variables-with-replacement-40percentBEBcharging.csv', index=False)
#coeff_df.to_csv(r'../../results/optimization-coefficients.csv', index=False)
#df.to_csv(r'../../results/lowcap-BM-optimized-variables-with-replacement-40percentBEBcharging-ContiniuedTo2040.csv', index=False)

#df.to_csv(r'../../results/lowcap-BM-optimized-variables-with-replacement-40percentBEBcharging-ContiniuedTo2040-charging-minus-50.csv', index=False) # Sensitivity: -50% Charging Cap
df.to_csv(r'../../results/midcap-BM-optimized-variables-with-replacement-40percentBEBcharging-ContiniuedTo2040-range-minus-50.csv', index=False) # Sensitivity: -50% Charging Cap



#df.to_csv(r'../../results/highcap-BM-optimized-variables-with-replacement-40percentBEBcharging-sensitivity-charging-minus-50.csv', index=False) # Sensitivity: -50% Charging Cap
#df.to_csv(r'../../results/lowcap-BM-optimized-variables-with-replacement-40percentBEBcharging-sensitivity-charging-minus-20.csv', index=False) # Sensitivity: -20% Charging Cap
#df.to_csv(r'../../results/lowcap-BM-optimized-variables-with-replacement-40percentBEBcharging-sensitivity-charging-plus-20.csv', index=False) # Sensitivity: +20% Charging Cap
#df.to_csv(r'../../results/highcap-BM-optimized-variables-with-replacement-40percentBEBcharging-sensitivity-charging-plus-50.csv', index=False) # Sensitivity: +200% Charging Cap
#df.to_csv(r'../../results/midcap-BM-optimized-variables-with-replacement-40percentBEBcharging-sensitivity-charging-plus-100.csv', index=False) # Sensitivity: +100% Charging Cap
#df.to_csv(r'../../results/midcap-BM-optimized-variables-with-replacement-40percentBEBcharging-sensitivity-charging-plus-200.csv', index=False) # Sensitivity: +200% Charging Cap
#df.to_csv(r'../../results/highcap-BM-optimized-variables-with-replacement-40percentBEBcharging-sensitivity-range-plus-300.csv', index=False) # Sensitivity: +300% Charging Cap


#df.to_csv(r'../../results/midcap-BM-optimized-variables-with-replacement-40percentBEBcharging-sensitivity-range-minus-50.csv', index=False) # Sensitivity: -50% Bus Range
#df.to_csv(r'../../results/lowcap-BM-optimized-variables-with-replacement-40percentBEBcharging-sensitivity-range-minus-20.csv', index=False) # Sensitivity: -20% Bus Range
#df.to_csv(r'../../results/lowcap-BM-optimized-variables-with-replacement-40percentBEBcharging-sensitivity-range-plus-20.csv', index=False) # Sensitivity: +20% Bus Range
#df.to_csv(r'../../results/highcap-BM-optimized-variables-with-replacement-40percentBEBcharging-sensitivity-range-plus-100.csv', index=False) # Sensitivity: -50% Bus Range
